...
namespace Engine {
	...
	public:
        ...
        // [NOTE]
        // Position: object's anchor's position on the whole screen (think: absolute position)
        // Anchor: object's anchor's position inside the object (think: relative position to object itself),
        //         where (0, 0) means anchor is at object's top left, (1, 0) means top right.
