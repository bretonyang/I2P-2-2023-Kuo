...
void PlugGunTurret::CreateBullet() {
    ...
    float rotation = atan2(diff.y, diff.x); // atan(y/x)
    ...
    Engine::Point shooting_position = Position + normalized * 36;
    getPlayScene()->EffectGroup->AddNewObject(new ShootingEffect(shooting_position.x, shooting_position.y));
